...
#. Update */opt/perfsonar_ps/mesh_config/etc/gui_agent_configuration.conf* with the URL of your JSON file::
...
* /opt/perfsonar_ps/mesh_config/etc/gui_agent_configuration.conf
...
+---------------------------+---------------------+----------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+ 
| restart_services          | 0 or 1              | Yes      | The 'restart_services' option can be used to specify whether the services should be restarted after their configuration is updated. If the 'use_toolkit' variable is set to 0, you will need to use the 'cron-restart_gui_services' cron script included in /opt/perfsonar_ps/mesh_config/doc to restart the services. See :ref:`config-cron`. |
+---------------------------+---------------------+----------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+ 
