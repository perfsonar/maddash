...
public class RowsResource {
    Logger log = Logger.getLogger(RowsResource.class);
    Logger netLogger = Logger.getLogger("netLogger");
    @Context UriInfo uriInfo;
    
    final private String GET_EVENT = "maddash.www.rest.RowsResource.get";
    ...
    public Response get(@Context HttpHeaders httpHeaders){
        ...
        try{
            json = MaDDashGlobals.getInstance().getResourceManager().getRows();
        }catch(Exception e){
